...
public interface RegionRepository extends JpaRepository<RegionEntity, Long> {
    ...
    @Query("select new com.mate.band.domain.common.dto.RegionData(re.id , re.regionName, de.id, de.districtName) as name from RegionEntity re inner join re.districts de")
